...
const EXPERIENCED_PLAYER_OPINION_EXEMPT_THRESHOLD = 20;
const EXPERIENCED_PLAYER_EMPHASIS_LOW_SHARE_THRESHOLD = 0.1;
const EXPERIENCED_PLAYER_EMPHASIS_HIGH_SHARE_THRESHOLD = 0.85;
